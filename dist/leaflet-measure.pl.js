!(function(e) {
            ...
            if (null !== (a = p ? c.geometries[b] : c)) {
              ...
              switch (((f = !r || ('Polygon' !== j && 'MultiPolygon' !== j) ? 0 : 1), j)) {
                case null:
                  break;
                case 'Point':
                  if (!1 === t(l, h, v, _, w)) return !1;
                  h++, _++;
                  break;
                case 'LineString':
                case 'MultiPoint':
                  for (n = 0; n < l.length; n++) {
                    if (!1 === t(l[n], h, v, _, w)) return !1;
                    h++, 'MultiPoint' === j && _++;
                  }
                  'LineString' === j && _++;
                  break;
                ...
                case 'MultiPolygon':
                  for (n = 0; n < l.length; n++) {
                    for ('MultiPolygon' === j && (w = 0), i = 0; i < l[n].length; i++) {
                      for (s = 0; s < l[n][i].length - f; s++) {
                        if (!1 === t(l[n][i][s], h, v, _, w)) return !1;
                        h++;
                      }
                      w++;
                    }
        ...
        if ((this._finishMeasure(), e.length)) {
          ...
          1 === e.length
            ? ((t = L.circleMarker(e[0], this._symbols.getSymbol('resultPoint'))),
              (r = b({ model: L.extend({ messages: this.options.messages }, o) })))
            : 2 === e.length
              ? ((t = L.polyline(e, this._symbols.getSymbol('resultLine'))),
                (r = _({
                  model: L.extend(
                    ...
                    o,
                    this._getMeasurementDisplayStrings(o)
                  )
                })))
  ...
  function(e, t, r) {
    function o(e, t, r) {
      ...
      var S = t.variable;
      S || (P = 'with (obj) {\n' + P + '\n}\n'),
        (P = (j ? P.replace(m, '') : P).replace(y, '$1').replace(g, '$1;')),
        (P =
          'function(' +
          (S || 'obj') +
          ') {\n' +
          ...
          'return __p\n}');
      var A = i(function() {
        return Function(M, C + 'return ' + P).apply(void 0, L);
      });
    ...
    function s(e) {
      ...
      if (p > 2) {
        for (u = 0; u < p; u++)
          u === p - 2
            ? ((n = p - 2), (i = p - 1), (s = 0))
            : u === p - 1 ? ((n = p - 1), (i = 0), (s = 1)) : ((n = u), (i = u + 1), (s = u + 2)),
            (t = e[n]),
            (r = e[i]),
            (o = e[s]),
